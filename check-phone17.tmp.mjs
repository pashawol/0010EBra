...
console.log('active after submit (fixed):', await page.evaluate(() => document.activeElement.id))

await page.click('#sBookingPhone')
console.log('active after direct phone click:', await page.evaluate(() => document.activeElement.id))
