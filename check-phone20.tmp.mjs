...
console.log('--- .validity.valid (no checkValidity(), no invalid event) on phone ---')
await page.evaluate(() => { const v = document.getElementById('sBookingPhone').validity.valid; console.log('read valid=', v) })
