...
console.log('1st phone click active:', await page.evaluate(() => document.activeElement.id))

await page.click('#sBookingPhone')
console.log('2nd phone click active:', await page.evaluate(() => document.activeElement.id))

await page.keyboard.type('99203423211', { delay: 20 })
await page.waitForTimeout(200)
console.log('value:', await page.inputValue('#sBookingPhone'))
