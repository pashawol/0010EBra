...
console.log('--- set aria-invalid on PHONE directly, no submit click ---')
await page.evaluate(() => document.getElementById('sBookingPhone').setAttribute('aria-invalid', 'true'))
